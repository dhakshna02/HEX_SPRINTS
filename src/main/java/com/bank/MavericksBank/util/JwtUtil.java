package com.bank.MavericksBank.util;
...
public class JwtUtil {
    private String SECRET_KEY="Hi_da_dhakshna_how_are_you_hope_you_will_do_this_project_without_error_in_first_time_itself";
    /*
